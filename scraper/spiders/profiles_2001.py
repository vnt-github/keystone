...
class ProfilesSpider(scrapy.Spider):
    ...
    def start_requests(self):
        raise scrapy.exceptions.CloseSpider("2001 stocks data profiles doesn't have enough inforamation like quarterly values of various field which are needed to make f,g and magic_score values")
